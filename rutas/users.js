...
router.get('/:userId',[authenticateUser,getUserById], async (req,res)=>{
    })
       
//-----POSTs-----

//post User
router.post('/signup',[validateRegister,validateUserAndMail,singUpUser],async (req,res)=>{
})
...
router.delete('/:userId',[authenticateUser,deleteUser],async(req,res)=>{
